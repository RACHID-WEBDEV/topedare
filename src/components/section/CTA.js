        ...
        <div className="py-5 mb-10 rounded-md  ">
            <div className="px-5 lg:px-6 lg:pl-8 xl:pl-20 xl:pr-8">
                <div className="relative">
                    <Fade top>
                        <SectionTitle title={ctaSectionHeading} />
                    </Fade>
                    <Fade left>
                        ...
                        <div className="">
                            <div className="px-3 lg:px-20 relative block  pb-20">
                                <div className="cta-content_top pl-4 lg:px-[100px] pt-[4.5rem] pb-[4.8125rem] bg-cta-bg relative block bg-scroll bg-no-repeat bg-cover " >
                                    <Fade top>
                                        <h2 className="text-white w-[19.5625rem] lg:w-[21.25rem] text-[1.625rem] lg:text-4xl font-medium mb-6 leading-[2.75rem]">{qoute}</h2>

                                    </Fade>
                                    <Fade bottom>
                                        <div className="name relative block pl-16">
                                            <p className="text-white text-lg lg:text-xl leading-4 font-normal">{qouteAuthor}</p>
                                        </div>
                                    </Fade>
                                </div>
                                    ...
                                    <div className="relative flex mb-10 lg:mb-0 items-center ">
                                        ...
                                        <Fade bottom>
                                            <div className="relative block pl-5">
                                                <p className="text-gray-600 text-lg lg:text-2xl leading-6 font-medium m-0 mb-2">{volunteerHeading}</p>
                                                <h2 className="text-2xl lg:text-5xl font-extrabold text-tdf-blue-50/80 ">{volunteerTitle}</h2>
                                            </div>
